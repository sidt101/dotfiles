...
alias bird='cd ~/projects/birdcage'
alias dw='cd ~/projects/birdcage-data-worker'
alias dwui='cd ~/projects/dataworker-ui'
...
alias os='cd ~/projects/optimize-suite'
alias pgb='cd ~/projects/pgb-backend'
alias tracking='cd ~/projects/tracking-hub'
alias layout='cd ~/projects/layout-service'
